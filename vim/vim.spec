...
%{_bindir}/rgview
%{_bindir}/rgvim
%{_mandir}/man1/eview.1.gz
%{_mandir}/man1/rgview.1.gz
%{_mandir}/man1/rgvim.1.gz
...
%changelog
* Tue Nov 19 2019 CasjaysDev <rpm-devel@casjaysdev.com> - 8.0.003-1
- Added support for python2 and python3
